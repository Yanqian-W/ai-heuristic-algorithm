...
import com.aim.heuristics.KBitDavissHC;
import com.aim.heuristics.ShallowestDescentHC;
...
public class Exercise1TestFrameConfig extends TestFrameConfig {
	...
	public String getConfigurationAsString() {
		return String.format("SAT instance #%d with a run time of %d " +
				"nominal seconds.", INSTANCE_ID, RUN_TIME);
	}
