...
public class Exercise0Runner extends TestFrame {
	...
	private void printResult(Result result) {
		...
		System.out.println(String.format("%d,%.1f,%.3f,%.3f", result.seed(),
				result.f_best(), result.cpuTimeTaken(),
				result.nominalTimeTaken()));
	}
	...
	public void runTests() {
		...
		System.out.println("seed, f_best, time_taken(CPU seconds)," +
				"time_taken(nominal seconds)");
